    ...
    <nav className="nav">
      <div className="container nav__inner">
        <a href="#hero" className="nav__brand" onClick={(e)=>{e.preventDefault(); onNavigate('hero');}}>
          <img className="nav__logo" src="../../assets/isotipo-gradient.png" alt="DM" />
...
function App() {
  ...
  return (
    <div data-screen-label="Portfolio Home">
      ...
      {toast && <div style={{position:'fixed', bottom:24, left:'50%', transform:'translateX(-50%)', background:'#f0592a', color:'white', padding:'10px 18px', borderRadius:8, fontFamily:'Space Mono', fontSize:12, letterSpacing:'0.10em', textTransform:'uppercase', zIndex:300, boxShadow:'0 8px 24px rgba(240,89,42,0.25)'}}>{toast}</div>}
    </div>
  );
}
